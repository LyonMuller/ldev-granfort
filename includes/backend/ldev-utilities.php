    ...
    <div class="aspect-16-9 ps-rel youtube-iframe ovf-h flex jcc aic" id="yt-<?= $videoId ?>">
      ...
      <script>
        function ldev_playVideo(yt) {
          ...
          iframe.setAttribute('class', 'w-100 aspect-16-9 ovf-h');
